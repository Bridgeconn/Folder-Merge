...
class FolderMergerThread(QThread):
    ...
    update_conversion_progress=pyqtSignal(int)
    ...
    def run(self):
        ...
        try:
            results=merge.merge_folders(self.base_dir,self.sub_folder,self. output_dir)
            ...
            merge.convert_to_mp3(self.output_dir)
             
            self.task_completed.emit("Conversion done successfully!")
